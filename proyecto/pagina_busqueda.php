   ...
   <body>
      ...
      <section class="buscar-form">
         <form action="" method="post">
            <input type="text" class="box" maxlength="100" placeholder="Busca aquí..." required name="buscar_caja">
            <button type="submit"class="fas fa-search" name="buscar-btn"></button>
         </form>
         </section>
         <!-- FORM DE BUSQUEDA -->
         <section class="home-productos" style="padding-top: 0; min-height:100vh">
            <h1></h1><br>
            <div class="box-container">
               <?php 
                  if(isset($_POST['buscar_caja']) OR isset($_POST['search_btn'])){
                  $buscar_caja = $_POST['buscar_caja'];
                  $select_productos = $conectar->prepare("SELECT * FROM `productos` WHERE name LIKE '%{$buscar_caja}%'");
